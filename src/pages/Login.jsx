...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      console.log(password, "pass", email,);
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="rounded-md bg-white p-8 shadow-sm">
          ...
          >
            ...
            <div>
              <button className="bg-primary text-primary-foreground hover:bg-primary/90 w-full bg-indigo-600 hover:bg-indigo-700 bg-primary text-primary-foreground hover:bg-primary/90 bg-primary text-primary-foreground hover:bg-primary/90 rounded-md h-8">
                Log In
              </button>
            </div>
            <div className="relative flex items-center">
              ...
              <span className="mx-4 flex-shrink text-sm text-gray-600">
                <Link to='/signup'>Create New Accoutn</Link>
              </span>
              <div className="flex-grow border-t border-gray-300" />
            </div>
